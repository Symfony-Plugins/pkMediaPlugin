    ...
    <div class="content">
      ...
      <div class="pk-admin-controls shadow caution">
        <div class="pk-admin-controls-padding caution-padding">
          ...
          <div id="pk-media-video-buttons">
            ...
            <?php if (pkMediaTools::getOption('embed_codes')): ?>
              <?php echo link_to_function("Add by Embed Code<span></span>", 
                "$('#pk-media-video-add-by-embed-form').show(); $('#pk-media-video-buttons').hide(); $('#pk-media-video-add-by-embed-heading').show();", array("class" => "pk-btn")) ?> 
            <?php endif ?>
          ...
          <?php if (pkMediaTools::getOption('embed_codes')): ?>
            <h4 id="pk-media-video-add-by-embed-heading">Add by Embed Code</h3>          
	        <?php endif ?>
            ...
            <?php if (pkMediaTools::getOption('embed_codes')): ?>
			      <form id="pk-media-video-add-by-embed-form" method="POST" action="<?php echo url_for("pkMedia/editVideo") ?>">
				        ...
				        <input type="text" id="pk-media-video-embed" name="pk_media_item[embed]" value="" />
								...
								<div id="pk-media-video-add-by-embed-form-submit">
					        <input type="submit" value="Go" class="submit" />
									<span class="or">or</span>
					        <?php echo link_to_function("Cancel<span></span>", "$('#pk-media-video-add-by-embed-form').hide(); $('#pk-media-video-add-by-embed-heading').hide(); $('#pk-media-video-buttons').show();", array("class" => "pk-cancel")) ?>
								</div>
